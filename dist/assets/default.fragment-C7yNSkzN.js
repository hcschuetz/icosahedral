import{a as e,i as ee,n as te,o as ne,r as re,t as ie}from"./mainUVVaryingDeclaration-YuCJTcz5.js";import{t}from"./index-D8tAAHAt.js";var n=`logDepthFragment`,r=`#ifdef LOGARITHMICDEPTH
...
#endif
`;t.IncludesShadersStoreWGSL[i]||(t.IncludesShadersStoreWGSL[i]=a);var oe={name:i,shader:a},o=`bumpFragment`,s=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;t.IncludesShadersStoreWGSL[o]||(t.IncludesShadersStoreWGSL[o]=s);var se={name:o,shader:s},c=`samplerFragmentDeclaration`,l=`#ifdef _DEFINENAME_
...
#endif
`;t.IncludesShadersStoreWGSL[c]||(t.IncludesShadersStoreWGSL[c]=l);var ce={name:c,shader:l},u=`bumpFragmentFunctions`,d=`#if defined(BUMP)
...
#endif
`;t.IncludesShadersStoreWGSL[u]||(t.IncludesShadersStoreWGSL[u]=d);var le={name:u,shader:d},f=`bumpFragmentMainFunctions`,p=`#ifndef TEXRD_DEFINED
...
#endif
`;t.IncludesShadersStoreWGSL[f]||(t.IncludesShadersStoreWGSL[f]=p);var ue={name:f,shader:p},m=`clipPlaneFragment`,h=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;t.IncludesShadersStoreWGSL[m]||(t.IncludesShadersStoreWGSL[m]=h);var de={name:m,shader:h},g=`clipPlaneFragmentDeclaration`,_=`#ifdef CLIPPLANE
...
#endif
`;t.IncludesShadersStoreWGSL[g]||(t.IncludesShadersStoreWGSL[g]=_);var fe={name:g,shader:_},v=`fogFragmentDeclaration`,y=`#ifdef FOG
...
#endif
`;t.IncludesShadersStoreWGSL[v]||(t.IncludesShadersStoreWGSL[v]=y);var pe={name:v,shader:y},b=`fresnelFunction`,x=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;t.IncludesShadersStoreWGSL[b]||(t.IncludesShadersStoreWGSL[b]=x);var me={name:b,shader:x},S=`imageProcessingDeclaration`,C=`#ifdef EXPOSURE
...
#endif
`;t.IncludesShadersStoreWGSL[S]||(t.IncludesShadersStoreWGSL[S]=C);var he={name:S,shader:C},w=`imageProcessingFunctions`,T=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;t.IncludesShadersStoreWGSL[w]||(t.IncludesShadersStoreWGSL[w]=T);var ge={name:w,shader:T},E=`lightFragment`,D=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[E]||(t.IncludesShadersStoreWGSL[E]=D);var _e={name:E,shader:D},O=`lightUboDeclaration`,k=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[O]||(t.IncludesShadersStoreWGSL[O]=k);var ve={name:O,shader:k},A=`ltcHelperFunctions`,j=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;t.IncludesShadersStoreWGSL[A]||(t.IncludesShadersStoreWGSL[A]=j);var ye={name:A,shader:j},M=`clusteredLightingFunctions`,N=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;t.IncludesShadersStoreWGSL[M]||(t.IncludesShadersStoreWGSL[M]=N);var be={name:M,shader:N},P=`lightsFragmentFunctions`,F=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
return result;}
#endif
`;t.IncludesShadersStoreWGSL[P]||(t.IncludesShadersStoreWGSL[P]=F);var xe={name:P,shader:F},I=`reflectionFunction`,L=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;t.IncludesShadersStoreWGSL[I]||(t.IncludesShadersStoreWGSL[I]=L);var Se={name:I,shader:L},R=`shadowsFragmentFunctions`,z=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;t.IncludesShadersStoreWGSL[R]||(t.IncludesShadersStoreWGSL[R]=z);var Ce={name:R,shader:z},B=`prePassDeclaration`,V=`#ifdef PREPASS
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[B]||(t.IncludesShadersStoreWGSL[B]=V);var we={name:B,shader:V},H=`oitDeclaration`,U=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;t.IncludesShadersStoreWGSL[H]||(t.IncludesShadersStoreWGSL[H]=U);var Te={name:H,shader:U},W=`textureRepetitionFunctions`,G=`#if TEXTURE_REPETITION_MODE>0
...
#endif
#define TEXRD_DEFINED
`;t.IncludesShadersStoreWGSL[W]||(t.IncludesShadersStoreWGSL[W]=G);var Ee={name:W,shader:G},K=`decalFragment`,q=`#ifdef DECAL
...
#endif
`;t.IncludesShadersStoreWGSL[K]||(t.IncludesShadersStoreWGSL[K]=q);var De={name:K,shader:q},J=`depthPrePass`,Y=`#ifdef DEPTHPREPASS
#if !defined(PREPASS) && !defined(ORDER_INDEPENDENT_TRANSPARENCY)
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);
#endif
return fragmentOutputs;
#endif
`;t.IncludesShadersStoreWGSL[J]||(t.IncludesShadersStoreWGSL[J]=Y);var Oe={name:J,shader:Y},X=`oitFragment`,Z=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;t.IncludesShadersStoreWGSL[X]||(t.IncludesShadersStoreWGSL[X]=Z);var ke={name:X,shader:Z},Q=`defaultPixelShader`,$=`#include<defaultUboDeclaration>
...
`;t.ShadersStoreWGSL[Q]||(t.ShadersStoreWGSL[Q]=$);var Ae=[ne,e,te,we,Te,ie,ee,ve,ye,be,xe,Ce,ce,me,Se,he,ge,Ee,ue,le,fe,re,pe,de,se,De,Oe,_e,ae,oe,ke];for(let e of Ae)t.IncludesShadersStoreWGSL[e.name]||(t.IncludesShadersStoreWGSL[e.name]=e.shader);var je={name:Q,shader:$};export{je as defaultPixelShaderWGSL};