import{a as e,i as ee,n as te,o as ne,r as re,t as ie}from"./mainUVVaryingDeclaration-C7VtrD9v.js";import{t}from"./index-ynopdZp8.js";var n=`clipPlaneFragmentDeclaration`,r=`#ifdef CLIPPLANE
...
#endif
`;t.IncludesShadersStore[n]||(t.IncludesShadersStore[n]=r);var ae={name:n,shader:r},i=`clipPlaneFragment`,a=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;t.IncludesShadersStore[i]||(t.IncludesShadersStore[i]=a);var oe={name:i,shader:a},o=`imageProcessingDeclaration`,s=`#ifdef EXPOSURE
...
#endif
`;t.IncludesShadersStore[o]||(t.IncludesShadersStore[o]=s);var se={name:o,shader:s},c=`imageProcessingFunctions`,ce=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;t.IncludesShadersStore[c]||(t.IncludesShadersStore[c]=ce);var le={name:c,shader:ce},l=`fogFragmentDeclaration`,u=`#ifdef FOG
...
#endif
`;t.IncludesShadersStore[l]||(t.IncludesShadersStore[l]=u);var ue={name:l,shader:u},d=`logDepthFragment`,f=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;t.IncludesShadersStore[d]||(t.IncludesShadersStore[d]=f);var de={name:d,shader:f},p=`fogFragment`,fe=`#ifdef FOG
...
#endif
`;t.IncludesShadersStore[p]||(t.IncludesShadersStore[p]=fe);var pe={name:p,shader:fe},m=`bumpFragment`,h=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;t.IncludesShadersStore[m]||(t.IncludesShadersStore[m]=h);var me={name:m,shader:h},g=`samplerFragmentDeclaration`,_=`#ifdef _DEFINENAME_
...
#endif
`;t.IncludesShadersStore[g]||(t.IncludesShadersStore[g]=_);var he={name:g,shader:_},v=`bumpFragmentFunctions`,y=`#if defined(BUMP)
...
#endif
`;t.IncludesShadersStore[v]||(t.IncludesShadersStore[v]=y);var ge={name:v,shader:y},b=`bumpFragmentMainFunctions`,x=`#ifndef TEXRD_DEFINED
...
#endif
`;t.IncludesShadersStore[b]||(t.IncludesShadersStore[b]=x);var _e={name:b,shader:x},S=`fresnelFunction`,C=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;t.IncludesShadersStore[S]||(t.IncludesShadersStore[S]=C);var ve={name:S,shader:C},w=`lightFragment`,T=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.IncludesShadersStore[w]||(t.IncludesShadersStore[w]=T);var ye={name:w,shader:T},E=`lightFragmentDeclaration`,be=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.IncludesShadersStore[E]||(t.IncludesShadersStore[E]=be);var xe={name:E,shader:be},D=`lightUboDeclaration`,Se=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;t.IncludesShadersStore[O]||(t.IncludesShadersStore[O]=k);var we={name:O,shader:k},A=`clusteredLightingFunctions`,j=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;t.IncludesShadersStore[A]||(t.IncludesShadersStore[A]=j);var Te={name:A,shader:j},M=`lightsFragmentFunctions`,N=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;t.IncludesShadersStore[M]||(t.IncludesShadersStore[M]=N);var Ee={name:M,shader:N},P=`reflectionFunction`,F=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;t.IncludesShadersStore[P]||(t.IncludesShadersStore[P]=F);var De={name:P,shader:F},I=`shadowsFragmentFunctions`,L=`#ifdef SHADOWS
...
#endif
#endif
`;t.IncludesShadersStore[I]||(t.IncludesShadersStore[I]=L);var Oe={name:I,shader:L},R=`decalFragmentDeclaration`,z=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;t.IncludesShadersStore[R]||(t.IncludesShadersStore[R]=z);var ke={name:R,shader:z},B=`defaultFragmentDeclaration`,V=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;t.IncludesShadersStore[B]||(t.IncludesShadersStore[B]=V);var Ae={name:B,shader:V},H=`prePassDeclaration`,U=`#ifdef PREPASS
...
#endif
#endif
`;t.IncludesShadersStore[H]||(t.IncludesShadersStore[H]=U);var je={name:H,shader:U},W=`oitDeclaration`,G=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;t.IncludesShadersStore[W]||(t.IncludesShadersStore[W]=G);var Me={name:W,shader:G},K=`textureRepetitionFunctions`,q=`#if TEXTURE_REPETITION_MODE>0
...
#endif
#define TEXRD_DEFINED
`;t.IncludesShadersStore[K]||(t.IncludesShadersStore[K]=q);var Ne={name:K,shader:q},J=`decalFragment`,Y=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;t.IncludesShadersStore[J]||(t.IncludesShadersStore[J]=Y);var Pe={name:J,shader:Y},X=`depthPrePass`,Fe=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;t.IncludesShadersStore[X]||(t.IncludesShadersStore[X]=Fe);var Ie={name:X,shader:Fe},Z=`oitFragment`,Le=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;t.IncludesShadersStore[Z]||(t.IncludesShadersStore[Z]=Le);var Re={name:Z,shader:Le},Q=`defaultPixelShader`,$=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;t.ShadersStore[Q]||(t.ShadersStore[Q]=$);var ze=[ke,Ae,ne,e,te,je,Me,ie,re,xe,Ce,we,Te,Ee,Oe,he,ve,De,se,le,Ne,_e,ge,ae,ee,ue,oe,me,Pe,Ie,ye,de,pe,Re];for(let e of ze)t.IncludesShadersStore[e.name]||(t.IncludesShadersStore[e.name]=e.shader);var Be={name:Q,shader:$};export{Be as defaultPixelShader};